...
export default class VikrantNerdlet extends React.Component {
  render() {
    return <>
    ...
    accountId = {3933528}
    query = "SELECT average(host.cpuPercent) AS 'CPU used %' FROM Metric WHERE `entityGuid` = 'MzkzMzUyOHxJTkZSQXxOQXw3Nzg0ODI0ODM2MTM4OTM1NzIz' TIMESERIES auto"
    fullWidth
    fullHeight
    />
